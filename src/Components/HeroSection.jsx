...
export default function HeroSection() {
  ...
  {/* New Customer Button with glow on hover */}
  <button
    onClick={() => navigate("/signup")}
    className="flex items-center px-6 py-3 bg-[#0575c5] rounded-xl justify-center 
               transition-shadow duration-300
               hover:shadow-[0_0_20px_#0575c5]"
  >
    <FaUserPlus className="mr-3" size={20} /> 
    <span className="mr-3 font-semibold">New Customer</span>
  </button>

  {/* Existing Customer Button with normal hover */}
  <button
    onClick={() => navigate("/signin")}
    className="flex items-center px-6 py-3 border-2 rounded-xl hover:bg-white hover:text-black transition justify-center"
  >
